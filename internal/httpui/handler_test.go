...
func TestHealthAndStaticRoutes(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "immediate prior stylesheet", method: http.MethodGet, path: "/static/" + immediatePriorAppStylesheetFilename, wantStatus: http.StatusOK, wantType: "text/css; charset=utf-8", bodyContains: "min-h-11"},
		...
		{name: "immediate prior stylesheet HEAD", method: http.MethodHead, path: "/static/" + immediatePriorAppStylesheetFilename, wantStatus: http.StatusOK, wantType: "text/css; charset=utf-8"},
