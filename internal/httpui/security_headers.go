...
// browserSecurityHeaders installs the fixed browser policy before any
// application handler writes a success, redirect, fragment, or error response.
// TLS and HSTS remain the edge proxy's responsibility because the application
// intentionally serves loopback HTTP.
//
