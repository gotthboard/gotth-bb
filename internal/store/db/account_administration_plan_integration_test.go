...
func TestAccountAdministrationPlansOnPostgreSQL17(t *testing.T) {
	...
	for _, mode := range []string{"force_custom_plan", "force_generic_plan"} {
		...
		requireAdministrationPlan(t, mode, "account-groups", membershipPlan, []string{`"Subplan Name":"CTE actor"`, `"Index Name":"forum_groups_pkey"`, `"Index Name":"forum_group_members_user_group_idx"`, `"Plan Rows":51`})
