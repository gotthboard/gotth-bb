...
VALUES (sqlc.arg(display_name), sqlc.narg(email), sqlc.narg(avatar_url), sqlc.arg(login_at))
RETURNING *;

-- name: InsertExternalIdentity :exec
INSERT INTO public.external_identities (user_id, issuer, subject, last_verified_at)
VALUES (sqlc.arg(user_id), sqlc.arg(issuer), sqlc.arg(subject), sqlc.arg(verified_at));
