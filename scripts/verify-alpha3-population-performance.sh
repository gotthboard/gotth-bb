...
alpha3_clean_process "$evidence_scratch" GOTTH_BB_RUN_POPULATION_PERFORMANCE=1 GOTTH_BB_TEST_DATABASE_URL="$GOTTH_BB_TEST_DATABASE_URL" \
...
grep -F 'population_migration rows=25000 preflight_batches=251 preflight_transactions=252 preflight_round_trips=254 mutation_batches=250 mutation_selection_queries=251 mutation_selected_rows=25000 generic_plan_mode=forced preflight_explain_queries=251 preflight_explain_returned_rows=25000 preflight_explain_examined_rows=25000 mutation_explain_queries=251 mutation_explain_returned_rows=25000 mutation_explain_examined_rows=25000' "$transcript" >/dev/null
