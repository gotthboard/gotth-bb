...
- A measured 100-row dense-task compatibility fixture on the pinned PostgreSQL
  17.10 image took 20.912355329 seconds and the test process peaked at a sampled
  78,072 KiB RSS. This is one deliberately expensive admitted fixture, not a
