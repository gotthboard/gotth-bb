...
| `GET, HEAD` | `/static/app-d8e495881d927546f70f69915c1807efc8fb02c2bc22c9d2a98e87736a04e210.css` | public exact content address | no | one-year public immutable | no / no / no | `404` |
