...
func TestInitialSchemaOnPostgreSQL17(t *testing.T) {
	...
	if serverVersion != 170010 || migrationCount != 14 || governanceCount != 1 {
		t.Fatalf("schema state = (version %d, migrations %d, governance %d), want (170010, 14, 1)", serverVersion, migrationCount, governanceCount)
	}
